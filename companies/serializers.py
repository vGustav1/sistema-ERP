...
class TaskSerializer (serializers.ModelSerializer):
    ...
    def update(self,instance, validated_date):
        ...
        instance.status_id = validated_date.get('status_id', instance.status_id)
        instance.employee_id = validated_date.get('employee_id', instance.employee_id)
        instance.due_date = validated_date.get('due_date', instance.due_date)
